...
const LookingForDriver = (props) => {
  return (
    <div>
      <h5 onClick={() => {props.setVehicleFound(false)}} className='absolute top-5 font-bold right-6 text-[5vw]'><i className="ri-arrow-down-wide-fill"></i></h5>
      <h3 className="font-bold text-[6vw] mb-[3vw]">Looking for Driver..</h3>
